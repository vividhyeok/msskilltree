...
export function TargetPanel({
  ...
  const recommendation = useMemo(
    () =>
      selected || !strategyOpen || !growthOpen ? null : getRecommendedPlan(run),
    [run, selected, strategyOpen, growthOpen],
  );
  ...
  return (
    <div className="hud-panel">
      ...
      <TargetSummary
        ...
        onBrowse={onBrowse}
      />
      <section className="focus-section" aria-label="선택 상세와 전략">
        {selected && (
        ...
        <div className="path-scroll">
          {!selected && (
            ...
            >
              <summary>
                <span>전략 · 메타 · 조합 계획</span>
                <small>필요할 때만 펼치기</small>
              </summary>
